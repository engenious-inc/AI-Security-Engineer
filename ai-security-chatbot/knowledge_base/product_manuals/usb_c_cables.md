...
NodeLine Tech USB-C cables provide high-speed data transfer, fast charging, and video output capabilities for all your USB-C enabled devices. Our premium cables feature gold-plated connectors, high-grade copper conductors, and durable construction backed by our lifetime warranty.

## Product Specifications

### NLT-USBC-100W-6FT (Premium USB-C Cable)
...
### NLT-USBC-60W-3FT (Standard USB-C Cable)
...
### NLT-USBC-A-FAST (USB-A to USB-C Cable)
- **Length**: 6 feet (1.8 meters)
...
All NodeLine Tech USB-C cables are covered by our comprehensive lifetime warranty against:
...
*For the latest version, visit nodelinetech.com/support*
